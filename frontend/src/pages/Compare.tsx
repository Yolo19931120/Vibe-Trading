...
const METRICS: MetricDef[] = [
  { key: "total_return",           labelKey: "metrics.totalReturn",         type: "pct", higherIsBetter: true },
  { key: "annualized_return",      labelKey: "metrics.annualizedReturn",    type: "pct", higherIsBetter: true },
  { key: "sharpe",                 labelKey: "metrics.sharpe",              type: "num", higherIsBetter: true },
  { key: "calmar_ratio",           labelKey: "metrics.calmarRatio",         type: "num", higherIsBetter: true },
  { key: "sortino_ratio",          labelKey: "metrics.sortinoRatio",        type: "num", higherIsBetter: true },
  { key: "max_drawdown",           labelKey: "metrics.maxDrawdown",         type: "pct", higherIsBetter: false },
  { key: "volatility",             labelKey: "metrics.volatility",          type: "pct", higherIsBetter: false },
  { key: "win_rate",               labelKey: "metrics.winRate",             type: "pct", higherIsBetter: true },
  { key: "profit_factor",          labelKey: "metrics.profitFactor",        type: "num", higherIsBetter: true },
  { key: "avg_win",                labelKey: "metrics.avgWin",              type: "pct", higherIsBetter: true },
  { key: "avg_loss",               labelKey: "metrics.avgLoss",             type: "pct", higherIsBetter: false },
  { key: "trade_count",            labelKey: "metrics.tradeCount",          type: "int", higherIsBetter: true },
  { key: "max_consecutive_losses", labelKey: "metrics.maxConsecLosses",     type: "int", higherIsBetter: false },
  { key: "exposure_time",          labelKey: "metrics.exposureTime",        type: "pct", higherIsBetter: true },
  { key: "avg_holding_period",     labelKey: "metrics.avgHoldingPeriod",    type: "days", higherIsBetter: false },
];
  ...
  return (
    <div className="p-8 max-w-4xl space-y-6">
      <h1 className="text-xl font-bold flex items-center gap-2">
        <GitCompare className="h-5 w-5" /> {t("title")}
      </h1>
